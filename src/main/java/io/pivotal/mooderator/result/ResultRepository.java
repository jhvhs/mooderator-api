...
public interface ResultRepository extends JpaRepository<Result, Long> {
    ...
    @Query(value = "select new io.pivotal.mooderator.result.SurveyAnswerStatistics(r.question, r.questionId, r.answer, count(r) as results, date(r.sentDate) as day) from Result r where r.questionId = ?1 group by r.answer, date(r.sentDate) order by day desc")
